...
import { PhotoIcon, DocumentArrowDownIcon } from '@heroicons/react/24/solid'
...
const TableOrders = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error('Error creatiing new order: ', error.message)
    }
  }
