          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 26 26" width='20' height='20' strokeWidth={1.5} stroke="currentColor" className="">
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="3 3 18 18" strokeWidth="1.5" stroke="currentColor" className="" height='18' width='18'>
